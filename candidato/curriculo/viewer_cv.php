...
<title> Currículo | Maiorino Comunicação </title>
<style>
Body {
	widht: 100%;
	color: #000;
...
<table cellspacing="1" cellpadding="0">
	<tr>
		<td class="label" bgcolor="#F78F1E" ROWSPAN="3" width="70%" color="#FFFFFF"><b><span class="titulo"><?php echo $dados['nome']; ?></span>
...
<table>
	<tr>
		...
		<td bgcolor="#E8E8E8"><?php echo $dados['minicv']; ?></td>
	</tr>
</table>
...
<br />
	<table>
		<tr>
			...
			<td bgcolor="#E8E8E8"><?php echo $dados['outras_infos']; ?></td>
		</tr>
	</table>
