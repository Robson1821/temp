...
<body>
	...
	<br />
	<br />
	Existem <b><?php echo $total; ?></b> vagas(s) cadastradas no sistema
	<br />
	<br />
<table cellspacing="0" bgcolor="#5C2E91" cellpadding="5">
<tr>
<td class="td" width="120px"  align="center"><b>Código</b></td>
<td class="td" width="250px" ><b>Vaga</b></td>
<td class="td" width="120px" align="center"><b>Data</b></td>
<td class="td" width="80px"  align="center"><b>+ Infos</b></td>
</tr>
</table>
<?php

$query = 'SELECT * FROM vagas WHERE D_E_L_E_T_E_ = " " and status < "2" ORDER BY cod ASC LIMIT '.$begin.' , 10';
$query = mysql_query($query);
...
<table class="table" cellspacing="0" cellpadding="5" bgcolor="#E8E8E8" >
	<tr>
		<td width="120px"  align="center" >MRN002013<?php echo $linha['cod'] ?></td>
		<td width="250px" ><?php echo $linha['titulo'] ?></td>
		<td width="120px" align="center"><?php echo date('d/m/Y', strtotime($data));?></td>
		<td width="80px"  align="center">
			<form id="participar" name="participar" method="post" action="participar.php">
