...
<form action="atualiza.php" method="post" enctype="multipart/form-data" name="enviar" id="enviar" >
			...
			<tr>
				...
				<td class="input"><?php echo $linha['cpf']; ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td class="label">Data Cadastro:</td>
				<td class="input"><?php echo $linha['d_cadastro']; ?></td>
			</tr>
			<tr>
				<td class="label">Hora Cadastro:</td>
				<td class="input"><?php echo $linha['h_cadastro']; ?></td>
			</tr>
		</table>
<br />
