...
if( isset( $_POST['enviar'] ) ) {
	...
	if ($regs == 0) {
		...
		?>
			...
			location.href="../trabalhe-conosco.html";
            //-->
            </script>
        <?php
		...
		$msg	 = "<html xmlns='http://www.w3.org/1999/xhtml'><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'>
				...
				<br /></p><p class='corpo'>Sua solicita��o de recupera��o de senha do usu�rio <span class='destaque'>'$usuario'</span><span class='corpo'> foi bem sucedida!</span><br />
		...
		//Checamos se a mensagem foi enviada ou se teve algum erro...
			...
			?>
                <script language="JavaScript">
                <!--
                alert("Sua solicita��o foi efetuada com sucesso! Verifique sua caixa de e-mail.");
				location.href="../trabalhe-conosco.html";
                //-->
                </script>
            <?php
