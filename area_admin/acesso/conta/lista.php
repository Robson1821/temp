...
<tr>
<td class="td" width="500px"  ><b>Nome</b></td>
...
$query = "SELECT * FROM usuarios WHERE usuario = '".$usuario."' and D_E_L_E_T_E_ = ''";
...
<table class="table" cellspacing="0" cellpadding="0" bgcolor="#E8E8E8" >
	<tr>
		<td width="500px"   ><?php echo $linha['nome'] ?></td>
			<td width="100px" align="center">
				<form id="participar" name="participar" method="post" action="usuario.php">
					<input name="email"  type="hidden"  id="cod"     			value="<?php echo $linha['email']; ?>" />
					<input name="senha"  type="hidden"  id="titulo" 			value="<?php echo $linha['senha']; ?>" />
